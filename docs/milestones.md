# Milestones: ZK-PayLink (2-Week Sprint)

## Week 1: Core PayLink Functionality
*Focus: Smart Contracts and Basic Frontend.*

- **D1-D2: Soroban Escrow**: Complete the `paylink-contract` with deposit and claim logic (initially without ZK).
...
**Deliverables**: A functional (non-ZK) PayLink system where funds can be escrowed and claimed.
...
- **D10-D11: Soroban Verifier**: Generate the Soroban-compatible verifier contract. Integrate it into the `paylink-contract`.
...
**Deliverables**: The complete ZK-PayLink platform.
