...
export default function WalletPage() {
  ...
  // ΓöÇΓöÇΓöÇ SECURE / WELCOME VIEW ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        <div className="w-full max-w-3xl">
          ...
          <div className="text-center mb-8">
            <div className="relative inline-block mb-5">
              ...
              <div className="absolute -top-2 -right-2 text-2xl">≡ƒÄë</div>
            </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-6 mb-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-xs text-slate-500 font-semibold mt-0.5">Save these 24 words ΓÇö they are the only way to restore your wallet.</p>
              </div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
              {wallet.mnemonic.split(" ").map((word, i) => (
                <div key={i} className="bg-slate-50 border border-slate-100 rounded-xl p-2.5 flex flex-col items-center justify-center gap-1 hover:bg-slate-100 transition-colors">
                  ...
                  <span className="text-[12px] font-bold text-slate-800 tracking-wide">{showMnemonic ? word : "ΓÇóΓÇóΓÇóΓÇóΓÇó"}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl px-5 py-4 mb-6 flex items-start gap-3">
            <div className="w-8 h-8 rounded-xl bg-amber-100 flex items-center justify-center shrink-0 mt-0.5">
              <span className="text-base">ΓÜá∩╕Å</span>
            </div>
            <div>
  ...
  // ΓöÇΓöÇΓöÇ READY VIEW (existing wallet) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
              {wallet.mnemonic.split(" ").map((word, i) => (
                <div key={i} className="bg-slate-50 border border-slate-100 rounded-xl p-2.5 flex flex-col items-center gap-1">
                  ...
                  <span className="text-[12px] font-bold text-slate-800">{showMnemonic ? word : "ΓÇóΓÇóΓÇóΓÇóΓÇó"}</span>
                </div>
              ))}
            </div>
          </div>
  ...
  // ΓöÇΓöÇΓöÇ LOGIN (ONBOARDING) VIEW ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  return (
