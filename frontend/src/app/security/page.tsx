...
import { 
 ...
 Settings, Search, Bell, ChevronDown, ArrowLeft, Lock, CheckCircle2
} from "lucide-react";
...
const navItems = [
 ...
 { icon: Shield, label: "Security", active: true, href: "/security" },
   ...
   <main className="flex-1 flex flex-col min-w-0">
    <header className="w-full flex items-center justify-between py-6 px-8 sm:px-10 lg:px-12 bg-[#FAFBFF] sticky top-0 z-30 backdrop-blur-md border-b border-slate-100/50">
     <div className="flex flex-col">
      <h1 className="text-2xl sm:text-[28px] font-extrabold tracking-tight text-slate-900">Security</h1>
      <p className="text-sm font-medium text-slate-500 mt-1">Manage your account security and privacy settings</p>
     </div>
    ...
    <div className="px-8 sm:px-10 lg:px-12 pb-12 flex-1 flex flex-col gap-6 pt-6">
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-white rounded-[2rem] p-8 shadow-[0_12px_40px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col gap-6">
       <div className="w-16 h-16 rounded-2xl bg-green-50 border border-green-100/50 flex items-center justify-center">
      ...
      <div className="bg-white rounded-[2rem] p-8 shadow-[0_12px_40px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col gap-6">
       <div className="w-16 h-16 rounded-2xl bg-indigo-50 border border-indigo-100/50 flex items-center justify-center">
