              ...
              <div className="bg-white rounded-[2rem] p-8 shadow-[0_12px_40px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col gap-6">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6 sm:gap-4">
                  <div className="flex items-center gap-6 min-w-0">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-200 shrink-0 border-4 border-white">
                      <span className="text-white font-extrabold text-3xl sm:text-4xl">{emailName.charAt(0).toUpperCase()}</span>
                    </div>
                    <div className="flex flex-col min-w-0">
                      <div className="flex items-center gap-2.5 mb-1 flex-wrap">
                        <h2 className="text-xl sm:text-2xl font-extrabold text-slate-900 truncate">{emailName.charAt(0).toUpperCase() + emailName.slice(1)}</h2>
                        <span className="bg-indigo-50 text-indigo-600 px-2 py-0.5 rounded-lg text-[10px] sm:text-xs font-bold flex items-center gap-1 border border-indigo-100 shrink-0"><CheckCircle2 className="w-3 h-3 sm:w-3.5 sm:h-3.5" /> Verified</span>
                      </div>
                  ...
                  <button className="shrink-0 w-full sm:w-auto justify-center sm:justify-start px-4 py-2.5 sm:py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-600 border border-indigo-100 rounded-xl text-sm font-bold transition-colors flex items-center gap-2 whitespace-nowrap"><Edit2 className="w-3.5 h-3.5" /> Edit Profile</button>
                </div>
